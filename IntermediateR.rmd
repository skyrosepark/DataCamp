...
You can add as many else if statements as you like. Keep in mind that R ignores the reminder of the control structure once a condition has been found that is TRUE and the corresponding expressions have been executed.
```
2. Loops
